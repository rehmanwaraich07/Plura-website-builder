...
const PipelineValue = ({ subaccountId }: Props) => {
  ...
  return (
    <Card className="relative w-full xl:w-[350px]">
      <CardHeader>
        <CardDescription>Pipeline Amount</CardDescription>
      ...
      <CardContent className="text-sm text-muted-foreground">
        <p className="mb-2">
          Total Amount of all tickets in the given pipeline except the last
          lane. Your last lane is considered your closing lane in every
          pipeline.
        </p>
        <Select
