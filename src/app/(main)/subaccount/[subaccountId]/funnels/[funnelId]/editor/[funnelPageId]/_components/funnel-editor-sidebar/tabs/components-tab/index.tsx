...
import TowCloumnsPlaceholder from "./two-columns-placeholder";
import ThreeColumnsPlaceholder from "./three-columns-placeholder";
import ContactFormConponentPlaceholder from "./contact-form-placeholder";
...
const ComponentsTab = (props: Props) => {
  const elements: {
    ...
    {
      Component: <TowCloumnsPlaceholder />,
      label: "2 Columns",
      id: "2Col",
      group: "layout",
    },
    ...
    {
      Component: <ContactFormConponentPlaceholder />,
      label: "Contact",
      id: "contactForm",
      group: "elements",
    },
