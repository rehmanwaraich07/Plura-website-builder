...
const PipelineView = ({
  ...
  const onDragEnd = (droptResult: DropResult) => {
    console.log(droptResult);
    const { destination, source, type } = droptResult;
    ...
    <DragDropContext onDragEnd={onDragEnd}>
      <div className="bg-white/60 dark:bg-background/60 rounded-xl p-4 use-automation-zoom-in">
        <div className="flex items-center justify-between">
          ...
          <Button className="flex items-center gap-3" onClick={handleAddLane}>
            <Plus size={15} />
            Create Lane
          </Button>
        </div>
